...
class WebContinuousScroll : Fragment() {

    private val BASE_URL = "https://example.com"
    private val HTML_CONTENT_FILE_TITLE = "sampleContinuousScrollPage.html"

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val root = inflater.inflate(R.layout.fragment_web_continuous_scroll, container, false)
     ...
     */
    private fun loadWebViewContent(webView: WebView, properties: PlacementInfo.WebFeedProperties) {
